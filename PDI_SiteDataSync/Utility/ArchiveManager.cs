...
public class ArchiveManager : IArchiveManager
{
    ...
    public ArchiveManager(Logger logger, ILoggerFactory loggerFactory, string archiveFolder, string logsFolder)
    {
        _logger = logger;
    ...
    public string ArchiveDataFile(string excelFilePath, string timestamp)
    {
        try
        {
            ...
            string dataZipPath = Path.Combine(_archiveFolder, dataZipFileName);
    ...
    public string? ArchiveLogFiles(string timestamp)
    {
        ...
        string logZipPath = Path.Combine(_archiveFolder, logZipFileName);
